...
namespace CodeBase.CameraLogic._2D_Camera.Scripts
{
    ...
    public class Camera2D : MonoBehaviour
    {
        ...
        /// </summary>
        public float followDampeningX = 0.4f;

        /// <summary>
        /// How fast to track the target along the Y axis.
        /// A higher number means a faster track speed
        /// </summary>
        public float followDampeningY = 0.6f;
        ...
        /// </summary>
        public float lookAheadAmount = 0.4f;
        ...
        private void Look() {
            ...
            if (targets.Count == 1) {
                Vector2 lookAhead = targets[0].GetVelocity() * lookAheadAmount;
                ...
                cameraTarget.transform.position = new Vector2(Mathf.SmoothDamp(fromPos.x, targetPlayerPos.x, ref velocity.x, followDampeningX),
                    Mathf.SmoothDamp(fromPos.y, targetPlayerPos.y, ref velocity.y, followDampeningY));
